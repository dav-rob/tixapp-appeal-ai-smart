...
This enables us to concurrently build the features in parallel so we can test and validate each subagent's changes in isolation then pick the best changes.
